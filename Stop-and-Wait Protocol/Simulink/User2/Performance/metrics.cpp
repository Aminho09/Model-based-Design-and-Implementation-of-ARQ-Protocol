      ...
      handler(nullptr, localIP, localPort, targetIP, targetPort)
{
    ...
    QObject::connect(&wrapper, &Wrapper::sendPacket, &handler, &UdpHandler::sendPacket);
    QObject::connect(&wrapper, &Wrapper::receiveAck, &handler, &UdpHandler::sendAck);
    QObject::connect(&wrapper, &Wrapper::receiveData, this, &Metrics::processOutputs);
    QObject::connect(this, &Metrics::reset_receiver, &wrapper, &Wrapper::resetReceiver);
    ...
    QObject::connect(this, &Metrics::reset_sender, &wrapper, &Wrapper::resetSender);
